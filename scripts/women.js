 ...
 checkboxes1.forEach(function(element) {
    element.addEventListener('change', function() {
      ...
      function fetchedData(element){
        console.log(element.value)
        fetch(`https://mockapi-7431.onrender.com/products?price_lte=${element.value}&category=Women`)
...
sortby.addEventListener("change",()=>{
    if(sortby.value=="lowtohigh"){
        ...
        fetch(`https://mockapi-7431.onrender.com/products?_sort=price&_order=asc&category=Women`)
        ...
        fetch(`https://mockapi-7431.onrender.com/products?_sort=price&_order=desc&category=Women`)
