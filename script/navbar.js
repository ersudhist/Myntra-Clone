...
function navbar() {
    return `<header class="header">
      ...
      <nav>
        ...
        <ul class="menu-items">
          <li>
            <a href="../HTML/mens.html" class="menu-item-1">MEN</a>
            <div class="mega-menu">
              <div class="content">
                <div class="col">
                  <section>
                    ...
                    <ul class="mega-links">
                      ...
                      <li><a href="./ProductMen.html">Casual Shirts</a></li>
                ...
                <div class="col">
                    <section>
                      <h2 class="item-1-heading">Fashion Accessories</h2>
                      <ul class="mega-links">
                      ...
                      <h2 class="item-1-heading">Bags & Backpacks</h2>
                      <h2 class="item-1-heading">Luggages & Trolleys </h2>
                    </section>
                  </div>
              </div>
            </div>
              ...
              <div class="content">
                <div class="col">
                  <section>
                    ...
                    <ul class="mega-links">
                      <li><a href="./ProductWomen.html">Kurtas & Suits</a></li>
                ...
                <div class="col">
                  <section>
                    <h2 class="item-2-heading">Western Wear</h2>
                    <ul class="mega-links">
                ...
                <div class="col">
                  <section>
                    <h2 class="item-2-heading">Lingerie & Sleepware</h2>
                    <ul class="mega-links">
                      <li><a href="#">Bra</a></li>
                    ...
                    <h2 class="item-2-heading">Beauty & Personal Care</h2>
                    <ul class="mega-links">
                ...
                <div class="col">
                  <section>
                    <h2 class="item-2-heading">Gadgets</h2>
                    <ul class="mega-links">
                      <li><a href="#">Smart Wearables</a></li>
                      <li><a href="#">Fitness Gadgets</a></li>
                      <li><a href="#">Headphones</a></li>
                    ...
                    <h2 class="item-2-heading">Jewellery</h2>
                    <ul class="mega-links">
                      <li><a href="#">Fashion Jewellery</a></li>
                      <li><a href="#">Fine Jewellery</a></li>
                      <li><a href="#">Earings</a></li>
                    </ul>
                    <h2 class="item-2-heading">Backpacks</h2>
                    <h2 class="item-2-heading">Handbags,Bags & Wallets</h2>
                    <h2 class="item-2-heading">Luggages & Trolleys</h2>
                  </section>
                </div>
              </div>
            </div>
              ...
              <div class="content">
                <div class="col">
                  <section>
                    ...
                    <ul class="mega-links">
                      <li><a href="./ProductKids.html">T-Shirts</a></li>
                ...
                <div class="col">
                  <section>
                    <h2 class="item-3-heading">Kids Accessories</h2>
                    <ul class="mega-links">
                    ...
                    <h2 class="item-3-heading">Brands</h2>
                    <ul class="mega-links">
                      <li><a href="#">H&M</a></li>
          ...
          <li>
            ...
            <div class="mega-menu">
              <div class="content4">
                ...
                <div class="col">
                  <section>
                    <h2 class="item-5-heading">Top Brands</h2>
                    <ul class="mega-links">
              ...
              <div class="content-6">
                <div class="col">
                  <section>
                   ...
                   <div class="explore">
                    <button class="exp"> EXPLORE STUDIO <i class="fa fa-light fa-angle-right"></i></button>
                   </div>
      ...
      <div class="nav-last">
      <div>
        <a href=""><img id="svg" src="https://www.svgrepo.com/show/198180/user-profile.svg"alt=""/></a>
      ...
      <div>
        <a href="../HTML/wishlist.html"> <img id="svg"src="https://www.svgrepo.com/show/14970/heart.svg"alt=""/></a>
